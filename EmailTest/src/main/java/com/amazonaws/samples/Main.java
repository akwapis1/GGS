...
public class Main {
	...
	public static void main(String[] args) {
		...
		while(inLoop) {
			...
			} else if (input == JOptionPane.CLOSED_OPTION || input == JOptionPane.CANCEL_OPTION) {
				System.exit(0);  
			}
	...
	public static void addStudents() {
		...
		for (int i = 0; i < numStudents; i++) {
			...
			AmazonSESSample anEmail = new AmazonSESSample(name, email, "Group Project Registration","Your instructor has added you to a new group project");
		}
